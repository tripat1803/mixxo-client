          ...
          {!loader && (
            ...
            >
              ...
              <Box>
                ...
                <Field
                  flag={editAccount}
                  value={lastname !== "" && lastname ? lastname : "Empty"}
            ...
            {shippingDetails &&
              ...
              shippingDetails.map((item) => {
                return (
                  <ShippingCard
                    key={item._id}
                    defaultBool={item?.shippingId?.default}
                    id={item?.shippingId?._id}
                    address={item?.shippingId?.address}
                    city={item?.shippingId?.city}
                    mobile={item?.shippingId?.mobile}
